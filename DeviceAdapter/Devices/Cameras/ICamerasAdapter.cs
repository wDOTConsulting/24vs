namespace DeviceAdapter.Devices.Cameras
{
    public interface ICamerasAdapter : IDevicesAdapter
    {
        ...
        CamerasResponse CaptureSingle(string cam_id, string format);
        ...
        /// </param>
        /// <returns> Odpověď adaptéru kamery.</returns>
        CamerasResponse CaptureStreamBatch(string cam_id, string format, int num_images, int fps); //
    }
}